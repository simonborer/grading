...
const a11y = {
    ...
    group: {
        ...
        req: [
            ...
            new Qu("Late penalty? (☑ = penalty, ☒ = no penalty)", -2.5)
        ],
    ...
    reading2: {
        ...
        req: [
            ...
            new Qu("Late penalty? (☑ = penalty, ☒ = no penalty)", -1)
        ],
        fb: ['How would it change your workflow if you had a visually impaired teammate who was working collaboratively with you on your code? Beyond just websites, would it change how you code (and comment your code), document, write emails, etc.?']
    },
    reading3: {
        total: 5,
        req: [
        ...
        fb: ["Could've dug a little deeper (where can we see this effect in action on the web? what opportunities might be missed?), but still good work.", "Meeting some people's needs turns out to meet even more people's wants :)"]
    },
    reading4: {
        total: 5,
        req: [
    ...
    reading5: {
        ...
        fb: ["What does it mean that there are so many people with different needs? How will you balance those concerns if they're in conflict? How will you identify needs that aren't captured in this one particular Twitter thread."]
    },
    reading6: {
        total: 5,
        req: [
